...
public interface TakeGoodsService {
     ...
     * @return
     */
    void paidPickUp(Long payInfoId) throws WxException;
     ...
     * @return
     */
    RespResult payForDetailTakeGoods(Long bizId, UserLoginInfo userLoginInfo, HttpServletRequest request) throws IOException;
     ...
     * @param userInfoId
     */
    void cancelTakeGoods(Long deliveryOrderId,Long userInfoId) throws IOException;

    /**
     * 超时自动取消商品提货(定时任务执行)
     * @param deliveryOrderId
     */
    void cancelExpireTakeGoods(Long deliveryOrderId) throws IOException;

    /**
     * 提货时不需要付钱时，直接更新所有相关订单信息
     * @param deliveryOrder
     */
    void updateTakeGoodsNoPay(DeliveryOrder deliveryOrder);
