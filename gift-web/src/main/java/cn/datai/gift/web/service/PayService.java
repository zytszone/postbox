...
public interface PayService {
     ...
     */
    Map payChannelOrder(PayInfo payInfo, PayChannel payChannel, Map params);
     ...
     */
    PayInfo wxPayResultNotify(WxPayNotifyReceiver wxPayNotifyReceiver) throws WxException;

    void afterPayBizHandler(PayInfo payInfo) throws WxException;

    /**
     * 订单支付结果查询
     * @param payInfo
     */
    void payOrderQuery(PayInfo payInfo) throws WxException;
     ...
     * @throws WxException
     */
    void payRefundQuery(RefundOrderWx refund) throws WxException;
     ...
     * @param payParams
     */
    Map<String, String> payOriginalChannel(PayInfo payInfo, HashMap<String, String> payParams);

    /**
     * 申请退款
     * @param payInfoId 基本支付信息id
     */
    void refund(long payInfoId) throws WxException;

    /**
     * 给某微信支付订单查找或新建退款订单信息
     * @throws WxException
     */
    RefundOrderWx createOrFindRefundOrderWx(PayOrderWx payOrderWx) throws WxException;
    ...
    interface WXPayService{
         ...
         * @throws WxException
         */
        WxPayOrderQueryResponse wxJsapiQuery(String transactionId, String outTradeNo) throws IllegalAccessException, WxException;

        /**
         * 上报微信支付订单信息，将返回的预付订单信息存入微信支付订单中，并修改对应的状态
         * @param payOrderWx
         */
        PayOrderWx callAndBindWxPrepayInfo(PayOrderWx payOrderWx);
    }
     ...
     * @param tradeOrderId
     */
    RespResult payforBuyCommodity(UserLoginInfo userLoginInfo, Long tradeOrderId,HttpServletRequest request);
