...
public interface BuyCommodityService {
     ...
     * @param payInfoId
     */
    void paidBuyCommodity(Long payInfoId) throws WxException;
     ...
     * @param tradeOrderId
     */
    void cancelBuyCommodityInfo(Long tradeOrderId,Long userInfoId);

    /**
     * 超时时取消购买操作(下单完成，但是没有付款，不需要验证用户信息)
     * @param tradeOrderId
     */
    void cancelExpireBuyCommodityInfo(Long tradeOrderId);

    /**
     * 购买商品在不需要付款的情况下直接完成订单
     * @param tradeOrder
     */
    void updateBuyCommodityInfoNoPay(TradeOrder tradeOrder);
