...
public class CommodityServiceImpl implements CommodityService {
    ...
    public CommodityVo findById(long id) throws IOException {
        ...
        String str = redisTemplate.boundHashOps(RedisConstants.COMMODITY_SELF).get(String.valueOf(id)).toString();
    ...
    public List<CommodityVo> queryCommodityContract(Long commodityTypeId) throws IOException {
        ...
        List<CommodityVo> commodityVoList = JSONObject.parseArray(redisTemplate.boundHashOps(RedisConstants.COMMODITY_ALL).get(RedisConstants.COMMODITY_KEY).toString(),CommodityVo.class);
    ...
    public List<CommodityType> queryCommodityTypeList() {
        return JSONObject.parseArray(redisTemplate.boundHashOps(RedisConstants.COMMODITY_ALL_TYPE).get(RedisConstants.COMMODITY_ALL_TYPE_KEY).toString(),CommodityType.class);
    }
