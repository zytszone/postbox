            ...
            success: function (rsp) {
                if(rsp.code == 0){
                    ...
                    that.order={
                        ...
                        timeStart:(new Date(data.tradeOrder.createTime)).format('yyyy-MM-dd'),
                    ...
                    if(state == 'NOPAY') {
                        ...
                        //     that.order.countdown = GetRTime(data.endTime);
        ...
        pay:function () {
            ...
            if(that.isCancel){
                $.ajax({
                    ...
                    type: "POST",
                    data: {
                        commodityId:that.order.commodityContractId,
                        quantity:that.order.quantity,
                        quantityType:that.order.quantityType
                    },
                    dataType: "json",
                    success: function (rsp) {
                        if(rsp.code==0){
