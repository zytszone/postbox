            ...
            <ul class="search-list">
                <li class="gift-info" v-for="item in list">
                    <a v-bind:href="detailUrl+item.commodityContractId">
                        ...
                        <div>
                            <p class="gift-name">[{{item.type}}]{{item.name}}</p>
                            <p class="gift-detail"><span class="gift-money">￥{{item.money}}/{{item.standardUnitName}}</span><span class="desc">{{item.standardUnitMultiple}}{{item.unit}}/1{{item.standardUnitName}}</span></p>
                        </div>
                    </a>
                </li>
            </ul>
