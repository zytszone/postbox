    ...
    <div v-show="isPay">
        ...
        <div class="order-process">
            ...
            <div class="process-text">
                ...
                <div class="text-item">
                    <div class="title">{{deliveDetailInfo.state}}</div>
        ...
        <ul class="list-user border-top">
            <li class="nav-item">
                <label>礼品名</label><span>[{{deliveDetailInfo.type}}]{{deliveDetailInfo.name}}</span>
            </li>
            <li class="nav-item">
                <label>提货规格</label><span>{{deliveDetailInfo.rule}}</span>
            </li>
            <li class="nav-item">
                <label>提货数</label><span>{{deliveDetailInfo.number}}{{deliveDetailInfo.unit}}</span>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <label>抵扣数量</label><span>{{deliveDetailInfo.kouMoney}}元</span>
            </li>
            <li class="nav-item">
                <label>现金支出</label><span>{{deliveDetailInfo.cosh}}元</span>
            </li>
            <li class="nav-item">
    ...
    <div v-show="!isPay">
        ...
        <div class="gift-info clearfix">
            <div class="float-right gift-package">
                ×{{deliveDetailInfo.quantity}}
            </div>
            <div class="float-left product-img">
                <img v-bind:src="deliveDetailInfo.img">
            </div>
            <div class="float-left">
                <p class="gift-name">[{{deliveDetailInfo.commodityType}}]{{deliveDetailInfo.unit}}</p>
                <p class="gift-number">1{{deliveDetailInfo.unit}}</p>
