...
<div id="checkPasswordComponent">
    ...
    <div v-show="forgetPassword" class="forget-password"><a href="forgetPassword.jsp">忘记密码</a></div>
</div>
<!--page end-->
...
<script type="text/javascript" src="${staticPath}/static/js/views/setPassword.js"></script>
</body>
</html>