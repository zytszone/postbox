...
<!--page start-->
<div id="donation" class="bg-white">
    <div class="donation-title">转赠</div>
    <div class="securities-wrap">
        <div class="packet-name">商品使用劵</div>
        <div class="packet-detail">
            <div class="packet-number"><span class="number">{{product.number}}</span>克</div>
            <div class="name">【{{product.type}}】 {{product.name}}</div>
        </div>
        <div class="packet-money">价值约 {{money}} 元</div>
    </div>
...
<script type="text/javascript" src="${staticPath}/static/js/views/donation.js"></script>
</body>
</html>