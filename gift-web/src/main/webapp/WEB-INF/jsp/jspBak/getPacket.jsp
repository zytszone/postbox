...
<div id="getPacket" class="get-packet" v-bind:class="{open:isOpen}">
    <div class="packet-wrap" v-show="!isOpen">
        ...
        <%--<div v-if="packetFlag==2">--%>
            ...
            <%--<div class="btn-wrap"><button class="btn-default" v-on:click="setAccount">存入微礼包账户</button></div>--%>
        <%--</div>--%>
    </div>
    <div v-show="isOpen" class="open-wrap">
        <div v-if="packetFlag==3">
            ...
            <div class="btn-wrap"><a href="${basePath}gift/setPacket" class="btn-default">发礼品红包</a></div>
        </div>
    </div>
</div>
<!--page end-->
...
<script type="text/javascript" src="${staticPath}/static/js/views/getPacket.js"></script>
</body>
</html>