...
<div id="sellInOrder">
    ...
    <div class="gift-info clearfix">
        ...
        <div class="float-left">
            <p class="gift-name">[{{commodity.typeName}}]{{commodity.commodityName}}</p>
            <p class="gift-number">1{{commodity.unit}}（{{commodity.standardUnitMultiple}}{{commodity.singleUnit}}/{{commodity.standardUnitName}}）</p>
            <p class="gift-money">￥{{totalMoney}}元</p>
        </div>
    </div>
    <%--<div class="gift-control" v-if="product.cash>0">--%>
        <%--<label>现金支付</label><span>￥{{product.cash}}元</span>--%>
    <%--</div>--%>
...
<script type="text/javascript" src="${staticPath}/static/js/views/sellInOrder.js"></script>
</body>
</html>