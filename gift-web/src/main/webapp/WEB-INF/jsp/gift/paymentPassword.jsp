...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${staticPath}/static/css/views/password.css"/>
</head>
<body>
<script>
...
<div id="checkPasswordComponent">
   ...
   <%-- <div v-show="forgetPassword" class="forget-password"><a href="${basePath}password/forgetPassword">忘记密码</a></div>--%>
</div>
<!--page end-->
...
<script type="text/javascript" src="${staticPath}/static/js/views/paymentPassword.js"></script>
</body>
</html>