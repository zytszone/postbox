...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${staticPath}/static/css/views/sendPacket.css"/>
</head>
<body>
<script>
...
<!--page start-->
<div id="sendPacket" class="send-packet">
    <div class="packet-wrap">
        <div class="packet-text">红包已经包好</div>
        <div class="packet-border"></div>
        <div class="packet-btn">
            <button v-on:click="sendPacket" class="circle-btn">发红包</button>
        </div>
        <div class="packet-tip">未领取的红包将在24小时后退回至礼包账户</div>
    </div>
    <div v-show="isSend" class="page-cover"><img src="${staticPath}/static/images/share.png"></div>
</div>
    ...
    if(isWeixin()) {
        ...
        wx.ready(function () {
            ...
            wx.onMenuShareAppMessage({
                ...
                <%--desc: '${applicationScope['weixinDefaultShareDesc']}', // 分享描述--%>
                desc: '[有人送礼]领取'+nickName+'的礼品红包', // 分享描述
                link: url,//分享当前url
