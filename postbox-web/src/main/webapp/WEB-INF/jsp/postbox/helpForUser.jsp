...
<ul class="list-group"></div>
    ...
    <li class="list-group-item" onclick="submit();"><span style="color: orangered;" class="glyphicon glyphicon-move" aria-hidden="true"></span>&nbsp;&nbsp;积分兑换<span style="float: right;color: #777777;" class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></li>
