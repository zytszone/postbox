...
<div id="commodityDetails">
    ...
    <div class="footer-wrap clearfix">
        ...
        <div class="footer-item width2" v-on:click="sellInPacket" id="sellIn">
...
<script type="text/javascript" src="${staticPath}/static/js/views/commodityDetails.js?version=1"></script>
</body>
</html>