...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${staticPath}/static/css/views/accountDetails.css"/>
...
<div id="accountDetails">
    <div class="fixed">
        ...
        <div class="list-header clearfix">
            <span class="float-left name">礼包名</span>
            ...
            <ul>
                <li v-for="item in giftList">
                    <%--<a v-bind:href="url+item.commodityId"> --%>
                        <span class="float-left name">[{{item.type}}]{{item.name}}</span>
...
<script type="text/javascript" src="${staticPath}/static/js/views/accountDetails.js"></script>
</body>
</html>