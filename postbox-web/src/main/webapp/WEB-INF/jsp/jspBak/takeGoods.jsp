...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${staticPath}/static/css/views/takeGoods.css"/>
</head>
<body>
<script>
    ...
    <div class="bg-white">
        ...
        <div class="input-box clearfix">
            ...
            <div class="float-right input-inner">
                ...
                <input type="tel" v-model="inputNumber" placeholder="0">
            </div>
...
<script type="text/javascript" src="${staticPath}/static/js/views/takeGoods.js"></script>
</body>
</html>