...
<div id="setPacketDetails" class="get-packet open-self">
    <div class="open-wrap">
        ...
        <div class="packet-name">{{packet.name}}的“{{packet.commodityName}}”礼品红包</div>
        ...
        <div class="packet-header">已领取{{packet.receive}}/{{packet.doneeQuota}}个,{{packet.receiveNumber}}/{{packet.commodityTotalQuantity}}{{packet.commodityUnitName}}<span class="float-right" style="margin-top:0.12rem;color:#ff9933;" v-on:click="sendContinue">继续发送</span></div>
        <ul class="list-wrap">
