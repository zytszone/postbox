    ...
    <div v-else>
        <ul class="address-wrap">
            <li v-for="item in addressList">
                <div class="address-name"><span>{{item.username}}</span><span>{{item.telNumber}}</span></div>
                ...
                <div class="address-operation">
                    ...
                    <div>
                        <button class="address-btn" v-on:click="deleteAddress(item.userDeliveryInfoId)">删除</button>
                        <button class="address-btn" v-on:click="editAddress(item.userDeliveryInfoId)">编辑</button>
                    </div>
                </div>
            </li>
        </ul>
...
<script type="text/javascript" src="${staticPath}/static/js/views/address.js"></script>
</body>
</html>