...
var payOrder = new Vue({
            ...
            success: function (rsp) {
                if(rsp.code == 0){
                    ...
                    that.commodity={
                        ...
                        time:data.tradeOrder.orderTime,
                        logicId:data.tradeOrder.tradeOrderId,
                        state:data.tradeOrder.status,
                        cash:data.tradeOrder.actualPrice
                    }
                    setInterval(function () {
                        that.commodity.countdown = GetRTime(data.endTime);
                    },1000);
                }
            }
        });
    ...
    methods:{
        pay:function () {
            var that = this;
            $.ajax({
                url: basePath + "buyCommodity/order",
                type: "POST",
                data: {
