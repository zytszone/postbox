 ...
 */
@Configuration
public class WeixinAuthServiceConfiguration {
    ...
    @Bean
    public WeixinAuthService weixinApiService(@Qualifier("weixinAuthRetrofit") Retrofit retrofit) {
        return retrofit.create(WeixinAuthService.class);
    }
